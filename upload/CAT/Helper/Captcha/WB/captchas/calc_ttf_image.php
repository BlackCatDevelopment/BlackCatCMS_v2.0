...
require_once(CAT_PATH.'/CAT/Helper/Captcha/WB/captcha.php');
...
$t_fonts = file_list(CAT_PATH.'/CAT/Helper/Captcha/WB/fonts');
$t_bgs = file_list(CAT_PATH.'/CAT/Helper/Captcha/WB/backgrounds');
$fonts = array();
$bgs = array();
...
// create reload-image
$reload = ImageCreateFromPNG(CAT_PATH.'/CAT/Helper/Captcha/WB/reload_140_40.png'); // reload-overlay
