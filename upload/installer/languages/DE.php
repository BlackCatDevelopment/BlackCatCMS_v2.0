...
$LANG = array(
    'Actual' => 'Tatsächlich',
    'Check' => 'Prüfung',
    'If you need help, please <a href="">visit our forum</a>.' => 'Für Hilfestellung bitte unser Forum nutzen.',
    'must be writable' => 'muß beschreibbar sein',
    'not writable' => 'nicht schreibbar',
    'Path' => 'Verzeichnis',
    'Please check the results below and fix the issue(s) listed there.' => 'Bitte die untenstehenden Probleme prüfen und beheben.',
    'Pre-installation check(s) failed!' => 'Vorprüfung(en) fehlgeschlagen!',
    'Required' => 'Erwartet',
    'Sorry, but we encountered some issue(s) that will inhibit the installation.' => 'Entschuldigung, aber es wurden Probleme gefunden, die eine Installation verhindern.',
    'writable' => 'schreibbar',
    ...
    'This is the base URL of the CMS (=the directory where BlackCat CMS is installed). The base URL is used (=needed) to generate the correct URLs for Pages, CSS- and JavaScript inclusions, and so on.' => 'Dies ist die Basis-URL des CMS (=des Verzeichnisses, in dem BlackCat CMS installiert ist). Die Basis-URL wird verwendet (=benötigt), um beispielsweise die korrekten URLs für Seiten, CSS- und JavaScript-Einbindungen etc. zu generieren.',
    ...
    'The default timezone is used as presetting for new users, for example.' => 'Diese Einstellung wird beispielsweise beim Anlegen von Benutzern als Vorgabe verwendet.',
    'You can set the &lt;title&gt; attribute indiviually for each page. This setting will be used as a default for pages that do not have an individual setting.' => 'Sie können das &lt;title&gt; Attribut für jede Seite individuell belegen. Diese Einstellung wird als Vorgabe für Seiten verwendet, die keine individuelle Einstellung besitzen.',
    ...
    'The database you want to use must already be installed, and you must have a database admin user and password. If you are unsure what these terms mean you should probably contact your hosting provider.' => 'Die Datenbank muß bereits existieren, und Sie brauchen eine Benutzerkennung und ein Kennwort für diese Datenbank. Wenn Sie nicht sicher sind, was das bedeutet, sollten Sie sich mit Ihrem Provider in Verbindung setzen.',
    ...
    'Setting' => 'Einstellung',
    'Value' => 'Wert',
    'SSL available' => 'SSL verfügbar',
    'Please note: You have not set all mandatory options. Go back to the appropriate step to add missing data. The missing options are highlighted below.' => 'Bitte beachten: Sie haben nicht alle Pflichtfelder ausgefüllt. Bitte kehren Sie zum entsprechenden Schritt zurück und ergänzen Sie die fehlenden Informationen. Die fehlenden Optionen sind unten markiert.',
