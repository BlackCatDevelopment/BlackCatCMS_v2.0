    ...
    $.fn.gridderExpander = function(options) {
        ...
        return this.each(function() {
            ...
            function openExpander(myself) {
                ...
                /* ADD LOADING BLOC */
                var $htmlcontent = $(settings.showTemplate);
            ...
            function processContent(myself, thecontent){
                ...
                /* FORMAT OUTPUT */
                var htmlcontent = settings.outputTemplate;
                var nav         = "";

                if(settings.showNav){

                    /* CHECK IF PREV AND NEXT BUTTON HAVE ITEMS */
                    var prevItem = $(".selectedItem").prevAll('.gridder-list').first();
                    var nextItem = $(".selectedItem").nextAll('.gridder-list').first();
                ...
                htmlcontent = htmlcontent
                    .replace(/{{shownav}}/gi, nav)
                    .replace(/{{thecontent}}/gi, thecontent);
            ...
            _this.on("click", ".gridder-nav.next", function(e) {
                e.preventDefault();
                $(this).parents(".gridder-show").nextAll('.gridder-list').first().trigger("click");
            });

            /* PREVIOUS BUTTON */
            _this.on("click", ".gridder-nav.prev", function(e) {
                e.preventDefault();
                $(this).parents(".gridder-show").prevAll('.gridder-list').first().trigger("click");
            });
