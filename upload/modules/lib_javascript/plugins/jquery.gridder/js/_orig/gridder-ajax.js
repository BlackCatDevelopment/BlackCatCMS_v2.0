...
;(function($) {
    ...
    $.fn.GridderAjax = function(options) {
        ...
        var gridder = $(opts.gridder); // element for gridder content
		...
		if (State.hash.indexOf('?item=') !== -1){
			if(!$(this).hasAttr("data-gridder-url")) {
                var thisUrl = $(this).parentsUntil("[data-gridder-url=*]").first().data('gridder-url');
            } else {
                var thisUrl = $(this).data('gridder-url');
            }
            if(!$(this).hasAttr("data-gridder-title")) {
                var thisTitle = $(this).parentsUntil("[data-gridder-title=*]").first().data('gridder-title');
            } else {
                var thisTitle = $(this).data('gridder-title');
            }
