/**
 * Converts <fieldset> to jQuery Tabs
 * v1.0
 **/
(function(){
    ...
    $.fn.fieldset_to_tabs = function(options) {
		return this.each(function() {
			...
			var $nav = $('<ul class="nav nav-tabs inner nav-pills" role="tablist">');
			...
			form.children('fieldset').each(function(i){ // first level children
                $(this).children('legend').each(function(y){ // first level legend
                    $nav.append('<li class="nav-item"><a class="nav-link" href="#tab_'+i+'" aria-controls="tab_'+i+'" role="tab" data-toggle="tab">'+$(this).text()+'</a></li>');
                    $(this).remove();
                });
